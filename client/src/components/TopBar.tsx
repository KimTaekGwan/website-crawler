      ...
      <div className="flex-1 flex justify-between px-4 sm:px-6">
          ...
          <div className="max-w-2xl w-full">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search captures, tags, or websites"
                type="search"
              />
            </div>
          </div>
        ...
        <div className="ml-4 flex items-center md:ml-6">
          ...
          <Link href="/#new-capture">
            <button
              type="button"
              className="ml-3 bg-primary p-1 rounded-full text-white hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
            >
              <span className="sr-only">Add new capture</span>
              <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
